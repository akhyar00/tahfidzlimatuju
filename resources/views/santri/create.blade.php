...
<html>
<head>
    <title>Tambah Santri Baru - TAHFIDZ 57</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
         /* Salin style dari halaman Tambah Santri di web1.php yang lama */
    ...
    <div class="container">
        ...
        <div class="glass-card">
            <div class="header">
                ...
                <p>Lengkapi form di bawah untuk menambahkan data santri</p>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('santri.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Contoh: Muhammad Al-Fatih" required>
                    </div>
                    <div class="form-group">
